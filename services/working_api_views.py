...
class ServiceCategoryViewSet(viewsets.ModelViewSet):
    ...
    def get_serializer_class(self):
        from .working_serializers import ServiceCategorySerializer
...
class ServiceViewSet(viewsets.ModelViewSet):
    ...
    def get_serializer_class(self):
        from .working_serializers import ServiceListSerializer, ServiceDetailSerializer
        if self.action == 'list':
    ...
    def featured(self, request):
        ...
        from .working_serializers import ServiceListSerializer
...
class ServiceReviewViewSet(viewsets.ModelViewSet):
    ...
    def get_serializer_class(self):
        from .working_serializers import ServiceReviewSerializer
